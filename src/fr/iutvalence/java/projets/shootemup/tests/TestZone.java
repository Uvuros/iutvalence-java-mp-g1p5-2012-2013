...
public class TestZone
{
	...
	/**
	 * Permet de tester les classes Partie Ship Affichage Zone Position et Joueur,
	 * Doit afficher la zone de jeu (obstacle qui "tombe" et vaisseau qui bouge aléatoirement)
	 * @param args aucun
	 */
